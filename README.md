...
**Result:**
The half adder circuit successfully performs addition operations, producing accurate sum and carry outputs for all input combinations.
The half subtractor circuit effectively computes difference and borrow outputs, verifying its functionality for binary subtraction.
